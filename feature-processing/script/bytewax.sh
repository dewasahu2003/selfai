...
export DEBUG=true  # or false, depending on your needs
export BYTEWAX_KEEP_CONTAINER_ALIVE=true  # or false, depending on your needs
export $BYTEWAX_PYTHON_FILE_PATH="../main.py"
